...
def main():
    ...
    memory = SequentialMemory(limit=30000, window_length=TIME_STEP)
    ...
    dqn = DQNAgent(model=model, nb_actions=nb_actions, memory=memory, batch_size=BATCH_SIZE,
                   ...
                   enable_dueling_network=True, dueling_type='avg', target_model_update=200, policy=policy, gamma=.99)
